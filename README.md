...
更详细的 API 结构请查看[API 格式](./api.md)章节。
...
> 如果你想知道这个“简易博客”应用是怎样被设计出来的，可以查看[创建应用](./app-create.md)章节，快速入门设计自定义应用，所有人都可以设计更好更强大的应用。
...
如果你想了解更详细的使用方式，请查看[API 格式](./api.md)章节。

如果你想学习如何设计自定义应用，请查看[自定义应用](./app-create.md)目录。

我们在[最佳实践](./bp-user.md)中以 `需求-功能分析-数据库结构-API-界面` 的组合用描述和截图展示了一些常见应用从零到一的设计与实现，你可以通过查看实践的方式了解到完整应用的细节，能够更好的开发自定义应用并使用。

> 本着吃自己的狗粮原则，清林云 BaaS 控制台自身就使用了最佳实践中的[用户系统](./bp-user.md)和[组织系统](./bp-org.md)。
